    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="card-columns">
                <div class="card">
                    <img class="img-responsive" src="{{asset('img/53b0150c46fd23eb14d2c025b09e579d.jpg')}}" alt="" style="width: 100%; height: 10%">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                <p class="text-center"><a href="{{route('product.productdetail')}}" >View detail</a></p>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                <p class="text-center"><a href="{{route('product.productdetail')}}" class="btn btn-info btn-xs" role="button">Button</a></p>
                            </div>
                        </div>
                        </div>
                </div>
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div>$12</div>
                        <p class="text-right"><a href="{{route('product.productdetail')}}" class="btn btn-info btn-xs pull-right" role="button">Button</a></p>
                    </div>
                </div>
                <div class="card">
                    <img class="img-responsive" src="{{asset('img/53b0150c46fd23eb14d2c025b09e579d.jpg')}}" alt="" style="width: 100%; height: 10%">

    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-10 col-md-8 col-lg-8">
            ...
            <form class="form-group" action="{{route('PostEmployee')}}" method="POST" enctype="multipart/form-data">
                ...
                <div>
                    <label for="uname">ຊື້ເຂົ້າໃຊ້ລະບົບ</label>
                ...
                <div>
                    <label for="Comfirm_pwd">ຢືນຢັນລະຫັດຜ່ານ</label>
                ...
                <div>
                    <label for="name">ຊື່ພະນັກງານ</label>
                ...
                <div>
                    <label for="identification_card">ເລກບັດປະຈໍາຕົວ</label>

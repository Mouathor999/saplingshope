...
ຶ<br>
<div class="text-center"><h3>ລາຍການສິນຄ້າທີ່ລູກຄ້າສັ່ງຈອງ</h3></div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td><div class="div_in_td"><b>detailb</b></div></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="div_in_td">  <a href="" class="btn btn-outline-success"><i class="fas fa-eye" style="color: #1e7e34"></i></a></div>
                            </td>
                            <td>
